...
String displayText = "123456780123456789012345678901234567890";
...
void splashScreen() {
  String value = "DIGITAL   REVOLUTION LOADING   LOADING";
  for (int i = 0; i < 300; i++) {
    resetShiftRegister();
    digitalWrite(_data, HIGH);
    shiftClock();
...
//    Serial.println((char)sms.charAt(i));
